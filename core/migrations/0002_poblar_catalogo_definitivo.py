# En tu nuevo archivo de migración de core (ej: 0002_poblar_catalogo_definitivo.py)
...
def poblar_datos_definitivo(apps, schema_editor):
    ...
    # Crear Categorías automáticamente desde la lista de productos
    nombres_categorias = sorted(list(set(p["categoria"] for p in PRODUCTOS)))
    categorias_creadas = {nombre: Categoria.objects.get_or_create(nombre=nombre)[0] for nombre in nombres_categorias}
    ...
    for datos_prod in PRODUCTOS:
        ...
        Producto.objects.get_or_create(
            ...
            defaults={
                ...
                'imagen': None # Dejamos la imagen vacía para subirla manualmente
            }
        )
