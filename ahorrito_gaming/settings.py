...
DEBUG = config('DEBUG', default=True, cast=bool) # Asegúrate que el default sea True para desarrollo
...
INSTALLED_APPS = [
    ...
    'django.contrib.humanize', 'core.apps.CoreConfig', 'cart.apps.CartConfig',
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'static')] # Django buscará aquí tus CSS y JS

MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'media') # Django guardará aquí las imágenes que subas
